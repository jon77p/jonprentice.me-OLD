...
<div class="jumbotron" style="background-image: url('https:d31v04zdn5vmni.cloudfront.net/blog/wp-content/uploads/2012/02/featured-image-snippets-1-690x362.png'); background-size: cover;">
	...
	<div class ="container">
		...
		<h1 class="text-center" style="color: white; text-shadow: 2px 2px 5px gray;">jonprentice</h1>
		<h2 class="text-center" style="color: white; text-shadow: 2px 2px 5px gray;">This site is currently a <em>Work in Progress</em>.</h2>
